...
loader.load(
    ...
    // other stuff
    {
        url: "./bower_components/pace/pace.js"
    }, {
        url: "./js/TemplateView.js"
    },
    {
        url: "./js/Parse-to-do.js"
    }
).then(function() {
    ...
    Parse.initialize("hcy68yIlekFeeWO4Oiqmdaem4m2T7SL9GVQowQqU","6yyYTg4K2nHXFljfQeLxwjCSFxfvK55qsGQMLyt3");
    new Parse.TasksRouter();
})
